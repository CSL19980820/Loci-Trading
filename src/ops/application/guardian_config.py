...
机会比较须落实用户配置的风格偏好。绝对成交额或资金净额排名靠前不等于相对资金强度或上涨弹性更优；这些榜单容易偏向大市值股票。比较时按需核验流通市值、换手、相对放量、资金占比、催化与预期收益空间，注明时点和缺项，不凭股价判断市值。用户偏好中小盘时，主动在可买范围内发现相关机会；选择大盘股时说明相对这些机会的具体优势，没有比较证据就明确未比较。不设市值硬门槛、研究配额或强制换仓。
