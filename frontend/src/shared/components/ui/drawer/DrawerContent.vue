...
<template>
  <DrawerPortal>
    ...
    <DrawerContent
      ...
      :class="cn(
        'group/drawer-content bg-raised text-ink border-line fixed z-[var(--z-popup)] flex h-auto flex-col border shadow-lg',
        ...
        'data-[swipe-direction=down]:inset-x-0 data-[swipe-direction=down]:bottom-0 data-[swipe-direction=down]:mt-24 data-[swipe-direction=down]:max-h-[90dvh] data-[swipe-direction=down]:rounded-t-[20px] data-[swipe-direction=down]:border-b-0 data-[swipe-direction=down]:data-[state=open]:slide-in-from-bottom data-[swipe-direction=down]:data-[state=closed]:slide-out-to-bottom',
    ...
    >
      <DrawerHandle class="bg-line-strong mx-auto mt-2.5 mb-1 hidden h-1 w-10 shrink-0 rounded-full group-data-[swipe-direction=down]/drawer-content:block" />
      <slot />
    </DrawerContent>
  </DrawerPortal>
</template>
