...
.report-mobile-plans>section { border-left:2px solid var(--seal-border); padding:10px 12px; background:var(--surface-sunken); border-radius:0 7px 7px 0; }
