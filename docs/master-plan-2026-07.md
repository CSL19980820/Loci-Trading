...
> 立项日期：2026-07-26
> 状态：**历史归档，描述的是 DDD 拆分前的目录结构。** 文中指向 `src/palace.py`、
> `deploy/requirements-runtime.txt`、`operating-rules.md` 的链接均已失效——那正是本文
> 要重构掉的旧架构，重构已完成。读现状请看 `src/<context>/README.md` 与 `docs/adr/`。
