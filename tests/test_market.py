...
from src.market.store import MarketStore, MarketError, normalize_code, to_sina_symbol
...
class StoreTests(unittest.TestCase):
    ...
    def test_upsert_is_idempotent(self) -> None:
        frame = _quotes(self.dates)
        self.store.upsert_quotes("600519", frame, source="test")
        self.store.upsert_quotes("600519", frame, source="test")
